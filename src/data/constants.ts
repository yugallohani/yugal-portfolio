...
using use = useUsing("use")`,
  ...
  [SkillNames.PYTHON]: {
    ...
    name: "python",
    label: "Python",
    shortDescription: "the snake that bites back with AI magic! 🐍✨",
    color: "#3776ab",
  ...
  [SkillNames.MYSQL]: {
    ...
    name: "mysql",
    label: "MySQL",
    shortDescription: "classic SQL that never goes out of style! 🗄️💎",
    color: "#4479a1",
  ...
  [SkillNames.RESTAPI]: {
    ...
    name: "restapi",
    label: "REST APIs",
    shortDescription: "making services talk like they're best friends! 🤝📡",
    color: "#ff6b35",
  ...
  [SkillNames.DEVOPS]: {
    ...
    name: "devops",
    label: "DevOps",
    shortDescription: "bridging dev and ops like a tech diplomat! 🌉⚙️",
    color: "#326ce5",
  ...
  [SkillNames.AGILE]: {
    ...
    shortDescription: "sprinting through projects with style! 🏃‍♂️💨",
    color: "#00d4aa",
...
export const EXPERIENCE: Experience[] = [
  {
    ...
    company: "Blockchaintech - Blockchain Developer Intern",
    description: [
      "Developed decentralized applications (dApps) and smart contracts focusing on secure and scalable blockchain solutions.",
      "Enhanced user interaction and engagement across student and professional communities.",
      "Worked on blockchain deployment pipelines and testing workflows to ensure reliability and efficient execution across test networks.",
    ],
    skills: [
      SkillNames.JS,
      SkillNames.TS,
